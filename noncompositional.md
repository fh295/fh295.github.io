...
Nevertheless, and given these caveats - DALL-E makes what viscerally seem to be remarkable attempts to both account for the prototypical meanings of input words *and also* satisfy the physical and conceptual constraints of the world. 
...
Interestingly, my bet is that we would observe a clear difference in how well children do at the cube-scene sketching task between the ages of 4 and 12. We would probably also observe differences between the final sketches in cultures where people have a formal education and [those that do not](https://science.sciencemag.org/content/182/4112/553), and between populations that received the description in a one-off audible instruction and those who could repeatedly consult a written version. Our ability to learn the sort of systematic mental processes that allow us to construct multi-object scenes probably also benefits from our being physical beings who see, feel and hear the world from a first-person perspective, and practice [physically arranging things](https://www.pnas.org/content/117/42/25966). 

So, DALL-E is not as systematic as young children, and far less systematic than formally-educated adult humans with either perfect memories or a pen and paper. But for DALL-E, many of the environmental factors that give rise to this ability in humans are absent, replaced by a vast amount of uncorrelated views of things that make a good photograph on the internet. Understanding what really causes humans to develop into systematic beings, and what makes some humans much more systematic than others, can provide us with insight into how to create models with the powerful compositional capacity of neural networks *and* the systematicity we desire as well. 
...
It is precisely what appears to be an instinct for combining words in a way that respects many of the constraints of the world -- and in doing so matching our shared expectations and intuitions -- that is what makes DALL-E's predictions seem so magical to us. 
